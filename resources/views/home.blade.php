      ...
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
          <div class="flex items-center">
            <div class="shrink-0">
              <img class="size-8" src="https://cdn0-production-images-kly.akamaized.net/GHiZ-GHBD5jnvjyEWMCYlfctuxU=/1200x675/smart/filters:quality(75):strip_icc():format(jpeg)/kly-media-production/medias/3312745/original/038879900_1606873975-New_Project__3_.jpg" alt="Your Company">
            </div>
